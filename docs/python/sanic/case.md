...
本文档的这一部分是示例代码的简单集合，可以帮助您快速开始应用程序开发。这些示例大多数都是经过分类的，并为您提供了[Sanic存储库](https://github.com/huge-success/sanic/tree/master/examples)中的工作代码示例的链接。
...
有关更多示例和有用示例，请访问[Huge-Sanic](https://github.com/huge-success/sanic/tree/master/examples)的GitHub页面
